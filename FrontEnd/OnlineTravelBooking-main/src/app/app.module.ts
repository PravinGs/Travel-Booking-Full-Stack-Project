...
import { AdminTrainComponent } from './admin/admin-train/train.component';
import { AddTrainComponent } from './admin/admin-train/add-train/add-train/add-train.component';
import { TrainBookingComponent } from './travel/booking/Train Booking/train-booking/train-booking.component';
import { UpdateTrainComponent } from './admin/admin-train/update-train/update-train/update-train.component';
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      {path:'train/booking/:trainId', component: TrainBookingComponent},
      ...
      {path:'admin/train', component:AdminTrainComponent},
      {path:'admin/flight/add', component:FlightFormComponent},
      {path:'admin/train/add', component:AddTrainComponent},
      {path:'admin/flight/update', component:UpdateFlightComponent},
      {path:'admin/train/update/:trainId', component:UpdateTrainComponent},
      {path:'users/profile-update/:userId', component:UpdateProfileComponent}
