...
// }
  ...
  booking(bookingModel: any) {
    console.log(bookingModel['userEmail'])
    console.log(bookingModel['id'])
    console.log(bookingModel['seats'])

    return this.http.post(baseURL + '/booking/flight/add', bookingModel); //http://localhost:8080/api/flight-booking/add
  ...
  trainBooking(bookingModel: any) {
    return this.http.post(baseURL+"/booking/train/add", bookingModel)
  }
