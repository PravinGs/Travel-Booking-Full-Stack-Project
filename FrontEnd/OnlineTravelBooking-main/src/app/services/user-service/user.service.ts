...
export class UserService {
  ...
  getBookingsByUserId(id: any): Observable<Bookingdata[]>{
    return this.http.get<Bookingdata[]>(baseURL+"/booking/flight/get/"+id);
  }

  cancelBooking(id: any) {
      console.log("Service get's called....");
      return  this.http.delete(baseURL+"/booking/flight/delete/" + id);
  }
  ...
  update(id: any, user: any) {
    return this.http.put(baseURL + "/users/update/"+id, user)
  }
  getUserById(id: any) {
    return this.http.get<user>(baseURL+"/users/get/profile/"+id)
  }
}
