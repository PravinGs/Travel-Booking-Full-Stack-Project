...
export class UpdateProfileComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private userService: UserService, private formBuilder: FormBuilder, private _snackBar: MatSnackBar, private router: Router ) {
    ...
    this.reactiveForm = this.formBuilder.group({
      ...
      userNation: new FormControl('', [Validators.required]),
