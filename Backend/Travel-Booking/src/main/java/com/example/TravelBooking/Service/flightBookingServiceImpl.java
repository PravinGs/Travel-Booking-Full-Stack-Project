...
public class flightBookingServiceImpl implements FlightBookingService {
    ...
    @Override
    @Transactional
    public String booking(User user, Flight flight, BookingModel bookingModel) {
        ...
        flightBooking.setSeats(bookingModel.getSeats());
            ...
            if (flight.getFlightAvailability()) { // check whether this flight is having enough seats or not
                ...
                if (flightBooking.getSeats() <= availableSeats) {
                    ...
                    String Body = "" +
                            ...
                            "<p> Price : <strong>" + flight.getFlightFare() * bookingModel.getSeats()  + "</strong></p> " +
                            "<p> From : <strong>" + flight.getFlightSource()  + "</strong></p> " +
